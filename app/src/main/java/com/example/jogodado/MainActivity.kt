...
fun JogoDado(modifier: Modifier = Modifier){
    ...
    var imagemResult2 = when(result2){
        1 -> R.drawable.dice_1
        2 -> R.drawable.dice_2
        3 -> R.drawable.dice_3
        4 -> R.drawable.dice_4
    ...
    Column (
        ...
        Row {
            Image(painter = painterResource(id = imagemResult), contentDescription = "Dado")
            Image(painter = painterResource(id = imagemResult2), contentDescription = "Dado2")
        }
